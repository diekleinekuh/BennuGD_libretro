...
void init_c_type ()
{
    ...
    set_c_upper  (//(const unsigned char *)"áéíóúñçàèìòùäëïöüýâêîôûæãåõ",
					(unsigned char[]){0xe1,0xe9,0xed,0xf3,0xfa,0xf1,0xe7,0xe0,0xe8,0xec,0xf2,0xf9,0xe4,0xeb,0xef,0xf6,0xfc,0xfd,0xe2,0xea,0xee,0xf4,0xfb,0xe6,0xe3,0xe5,0xf5,0x0},
                  //(const unsigned char *)"ÁÉÍÓÚÑÇÀÈÌÒÙÄËÏÖÜÝÂÊÎÔÛÆÃÅÕ") ;
				    (unsigned char[]){0xc1,0xc9,0xcd,0xd3,0xda,0xd1,0xc7,0xc0,0xc8,0xcc,0xd2,0xd9,0xc4,0xcb,0xcf,0xd6,0xdc,0xdd,0xc2,0xca,0xce,0xd4,0xdb,0xc6,0xc3,0xc5,0xd5,0x0});
    ...
    set_c_upper  (//(const unsigned char *)"áéíóúñÑçÇàèìòùäëïöüýâêîôûæãåõÁÉÍÓÚ",
					(unsigned char[]){0xe1,0xe9,0xed,0xf3,0xfa,0xf1,0xd1,0xe7,0xc7,0xe0,0xe8,0xec,0xf2,0xf9,0xe4,0xeb,0xef,0xf6,0xfc,0xfd,0xe2,0xea,0xee,0xf4,0xfb,0xe6,0xe3,0xe5,0xf5,0xc1,0xc9,0xcd,0xd3,0xda,0x0},
                  //(const unsigned char *)"AEIOUNNCCAEIOUAEIOUYAEIOUÆAAOAEIOU") ;
					(unsigned char[]){0x41,0x45,0x49,0x4f,0x55,0x4e,0x4e,0x43,0x43,0x41,0x45,0x49,0x4f,0x55,0x41,0x45,0x49,0x4f,0x55,0x59,0x41,0x45,0x49,0x4f,0x55,0xc6,0x41,0x41,0x4f,0x41,0x45,0x49,0x4f,0x55,0x0});
    set_c_lower  (//(const unsigned char *)"áéíóúñÑçÇàèìòùäëïöüýâêîôûæãåõÁÉÍÓÚ",
					(unsigned char[]){0xe1,0xe9,0xed,0xf3,0xfa,0xf1,0xd1,0xe7,0xc7,0xe0,0xe8,0xec,0xf2,0xf9,0xe4,0xeb,0xef,0xf6,0xfc,0xfd,0xe2,0xea,0xee,0xf4,0xfb,0xe6,0xe3,0xe5,0xf5,0xc1,0xc9,0xcd,0xd3,0xda,0x0},
                  //(const unsigned char *)"aeiounnccaeiouaeiouyaeiouÆaaoaeiou") ;
				    (unsigned char[]){0x61,0x65,0x69,0x6f,0x75,0x6e,0x6e,0x63,0x63,0x61,0x65,0x69,0x6f,0x75,0x61,0x65,0x69,0x6f,0x75,0x79,0x61,0x65,0x69,0x6f,0x75,0xc6,0x61,0x61,0x6f,0x61,0x65,0x69,0x6f,0x75,0x0});
#endif
    ...
    set_c_from  (// (const unsigned char *)"áéíóúÁÉÍÓÚñÑçÇàèìòùÀÈÌÒÙäëïöüÄËÏÖÜÿýâêîôûÂÊÎÔÛ"
				 //	"æÆãåðõªºÃÅÐÕØ"
					...
					0xe6,0xc6,0xe3,0xe5,0xf0,0xf5,0xaa,0xba,0xc3,0xc5,0xd0,0xd5,0xd8,0x0}, CTYPE_ALPHA) ;
